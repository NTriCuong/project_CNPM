...
const AdminPage = () => {
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <button onClick={handleCreate} style={styleUpdate}> create</button>
                ...
                <tbody>
                    {flights.map((flight, index) => (
                        <tr key={index} >
                            ...
                            <td style={styleTd}>{new Date(flight.departure_time).toLocaleString()}</td>
                            <td style={styleTd}>{new Date(flight.arrival_time).toLocaleString()}</td>
                            ...
                            <td style={styleTd}> <button onClick={()=>handleUpdate(flight)} style={styleUpdate}> update </button></td>
                            <td style={styleTd}> <button onClick={()=>handleDelete(flight.flight_number)} style={styleDelete}>delete</button></td>
                        </tr>
                    ))}
                </tbody>
            </table>
