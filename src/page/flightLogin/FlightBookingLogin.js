    ...
    <div className="login-container">
      ...
      <div className="footer-info">
        <div className="flight-options">
              ...
              <div style={{color:'#EAF0F0', display:'inline-block',
                marginLeft:'0px' ,width:'220px', position:'relative',textAlign:'end'}}>
              <img src={calendar} alt='calendar' style={{width:'20px', position:'absolute',left:'40px',top:'2px'}}/>
            ...
            <div style={{color:'#EAF0F0',position:'relative',width:'220px',marginLeft:'22px'}}>
            <img src={history} alt='history' style={{width:'20px', position:'absolute',left:'-22px',top:'2px'}}/>
