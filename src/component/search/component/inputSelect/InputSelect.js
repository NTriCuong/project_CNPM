...
const InputSelect = forwardRef(
  ({ className, data, flag, searchText, setSearchText }, ref) => {
    ...
    useEffect(() => {
      if (!searchText.trim()) {
        ...
        const filtered = data.popular.filter(
          (item) =>
    ...
    return (
      <div className={className} ref={ref} onClick={(e) => e.stopPropagation()}>
        <input
          type="text"
